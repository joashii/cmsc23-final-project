        ...
        builder: (context, snapshot) {
          ...
          return FutureBuilder<DocumentSnapshot>(
            ...
            builder: (context, itemSnap) {
              ...
              final item = itemSnap.data!.data() as Map<String, dynamic>;
                                ...
                                Column(
                                  ...
                                  children: List.generate(
                                    ...
                                    (index) {
                                      ...
                                      final nextColor = (index < historyItems.length - 1)
                                          ? historyItems[index + 1]["color"] as Color
                                          : item["color"] as Color;
                                        ...
                                        ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            final confirmed = await _showConfirmationDialog(
                                              ...
                                              message: "Are you sure you want to cancel this accepted request?",
